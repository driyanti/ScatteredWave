...
c
                  i = ixsf+ix1
                  j = iysf+iy1
                  da = cdabs(  a2t(iz,ix1,iy1,-1,-1)
     &                     + a2t(iz,ix1,iy1,-1, 0)
     &                     + a2t(iz,ix1,iy1,-1, 1))
                  db = cdabs(a2t(iz,ix1,iy1,-1,-1))
                  dc = cdabs(a2t(iz,ix1,iy1,-1, 1))
                  dw = max(da,db,dc)
c
                  da = cdabs(  a2t(iz,ix1,iy1, 1,-1) 
     &                     + a2t(iz,ix1,iy1, 1, 0)
...
c
                  ...
                  do l = -1,1
                     do k = -1,1
                        csum = csum + cdabs(a2(iz,ix1,iy1,k,l)) ! modified abs
                     enddo
                  enddo
                  sigm = 0.5d0*
     &                   min(1.d0, cdabs(1.d0-csum/a2(iz,ix1,iy1,0,0)))
c                  c1 = a2 (iz,ix1,iy1, 1,-1) + a2 (iz,ix1,iy1, 1, 0) + 
c     &                 a2 (iz,ix1,iy1, 1, 1) - a2t(iz,ix1,iy1, 1,-1) -
c     &                 a2t(iz,ix1,iy1, 1, 0) - a2t(iz,ix1,iy1, 1, 1) -
c     &                 a2 (iz,ix1,iy1,-1,-1) - a2 (iz,ix1,iy1,-1, 0) -
c     &                 a2 (iz,ix1,iy1,-1, 1) + a2t(iz,ix1,iy1,-1,-1) +
c     &                 a2t(iz,ix1,iy1,-1, 0) + a2t(iz,ix1,iy1,-1, 1)
c
                  c1 = 0.d0
...
c
                  ...
                  do l = -1, 1
                     do k = -1, 1
                       csum = csum + cdabs(a2(iz,ix1,iy1, k, l))
                     enddo
                  enddo
                  sigm = 0.5d0*
     &                   min(1.d0,cdabs(1.d0-csum/a2(iz,ix1,iy1,0,0)))
c                  c2 = a2 (iz,ix1,iy1,-1, 1) + a2 (iz,ix1,iy1, 0, 1) +
c     &                 a2 (iz,ix1,iy1, 1, 1) - a2t(iz,ix1,iy1,-1, 1) -
c     &                 a2t(iz,ix1,iy1, 0, 1) - a2t(iz,ix1,iy1, 1, 1) -
c     &                 a2 (iz,ix1,iy1,-1,-1) - a2 (iz,ix1,iy1, 0,-1) -
c     &                 a2 (iz,ix1,iy1, 1,-1) + a2t(iz,ix1,iy1,-1,-1) +
c     &                 a2t(iz,ix1,iy1, 0,-1) + a2t(iz,ix1,iy1, 1,-1)
                  c2 = 0.d0
c
