      subroutine makeph2(a,ngx,ngy,ngz,omg,idata)
c
...
c      open(1,file='mata.dat')
c      do iz = 0,ngz+1
c         do iy = 0,ngy+1
c            do ix = 0,ngx+1
c               write(1,*) iy+1,ix+1,iz+1
c               write(1,*) a(ix,iy,iz,1)
c               write(1,*) a(ix,iy,iz,2)
c               write(1,*) a(ix,iy,iz,3)
c               write(1,*) a(ix,iy,iz,4)
c               write(1,*) a(ix,iy,iz,5)
c               write(1,*) a(ix,iy,iz,6)
c               write(1,*) a(ix,iy,iz,7)
c               write(1,*)
c            enddo
c         enddo
c      enddo
c      close(1)
c      
c      open(2,file='matb.dat')
c      do iy = 0,ngy+1
c         do ix = 0,ngx+1
c            do iz = 0,ngz+1
c               write(2,*) iy+1,ix+1,iz+1
c               write(2,*) a(iz,ix,iy,1)
c               write(2,*) a(iz,ix,iy,2)
c               write(2,*) a(iz,ix,iy,3)
c               write(2,*) a(iz,ix,iy,4)
c               write(2,*) a(iz,ix,iy,5)
c               write(2,*) a(iz,ix,iy,6)
c               write(2,*) a(iz,ix,iy,7)
c               write(2,*)
c            enddo
c         enddo
c      enddo
